...
gsap.fromTo("#freds", { y: -400, backgroundColor: "transparent" }, { y: -400 })
gsap.to("body", { scale: "1" });

gsap.fromTo(".title", { x: 100, y: 200 }, { duration: 3, x: 100, y: 200, width: "300", padding: "10", borderRadius: "15", fontFamily: "fantasy", fontSize: "15", opacity: ".5" });